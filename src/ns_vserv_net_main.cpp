...
public:
	...
	inline void checkReadOffset(uint32_t from_offset, uint32_t field_size)
	{
...
protected:
	void virtualRespond(NetworkPacket packet, Address *addr_vec, size_t addr_num) override
	{
